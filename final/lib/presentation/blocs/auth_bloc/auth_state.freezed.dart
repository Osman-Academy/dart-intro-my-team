...
abstract class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool loading, String? token, AuthUser? user, String? error});
...
class _$AuthStateImpl implements _AuthState {
  ...
  @override
  String toString() {
    return 'AuthState(loading: $loading, token: $token, user: $user, error: $error)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, loading, token, user, error);
...
class _$AuthUserImpl implements _AuthUser {
  ...
  @override
  String toString() {
    return 'AuthUser(id: $id, name: $name, email: $email, role: $role, avatarUrl: $avatarUrl)';
  }
