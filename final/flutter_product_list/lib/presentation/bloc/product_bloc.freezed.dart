...
class __$$SearchChangedImplCopyWithImpl<$Res>
    extends _$ProductEventCopyWithImpl<$Res, _$SearchChangedImpl>
...
class _$SearchChangedImpl implements SearchChanged {
  ...
  @override
  String toString() {
    return 'ProductEvent.searchChanged(query: $query)';
  }
...
abstract class SearchChanged implements ProductEvent {
  const factory SearchChanged(final String query) = _$SearchChangedImpl;
